...
| Medium | Chessboard | Piece colors were visually reversed even though White correctly moved first | Open Play and compare the logical piece colors with their styling | White pieces look white and Black pieces look black | White pieces were dark and Black pieces were white | Fixed |
...
- Corrected visually reversed piece colors and added explicit player-side labels.
