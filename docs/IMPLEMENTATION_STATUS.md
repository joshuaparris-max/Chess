...
- 120-puzzle adult tactics trainer: five difficulty bands, themes and phase tags, multi-move sequences with opponent auto-reply, black-to-move board flip, three-level progressive hints, difficulty filter, and local attempt/solved tracking
